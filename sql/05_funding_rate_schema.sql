...
-- 初始化数据
INSERT INTO t_funding_rate_config (symbol, max_rate, min_rate, interest_rate, status) VALUES
('BTCUSDT', 750000, -750000, 1000, 1),
('ETHUSDT', 750000, -750000, 1000, 1),
('SOLUSDT', 750000, -750000, 1000, 1)
