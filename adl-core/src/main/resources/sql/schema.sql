...
CREATE TABLE IF NOT EXISTS t_adl_ranking_queue (
    ...
    position_value DECIMAL(30, 8) NOT NULL COMMENT '持仓价值',
    ...
    -- 时间戳
    position_created_at BIGINT NOT NULL COMMENT '持仓创建时间（毫秒）',
    rank_updated_at BIGINT NOT NULL COMMENT '排名更新时间（毫秒）',
...
CREATE TABLE IF NOT EXISTS t_adl_execution (
    ...
    target_side TINYINT NOT NULL COMMENT '被ADL方向: 1=LONG 2=SHORT',
    ...
    executed_at BIGINT NOT NULL COMMENT '执行时间（毫秒）',
...
CREATE TABLE IF NOT EXISTS t_insurance_fund_log (
    ...
    -- 时间戳
    created_at BIGINT NOT NULL COMMENT '流水创建时间（毫秒）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='穿仓处理记录表';

-- =====================================================
-- 初始化数据
-- =====================================================
INSERT INTO t_insurance_fund (
...
(NULL, 'USDT', 1000000.00000000, 1000000.00000000, 0.00000000,
 1000000.00000000, 0.00000000, 0.00000000,
 0.00000000, 0.00000000, 0.00000000,
 0.00000000, 0.00000000, DATE_FORMAT(CURDATE(), '%Y%m%d'),
...
('BTCUSDT', 'USDT', 500000.00000000, 500000.00000000, 0.00000000,
 500000.00000000, 0.00000000, 0.00000000,
 0.00000000, 0.00000000, 0.00000000,
 0.00000000, 0.00000000, DATE_FORMAT(CURDATE(), '%Y%m%d'),
 500000.00000000, 500000.00000000,
 500000.00000000, 250000.00000000, 50000.00000000, 'SAFE',
 0, UNIX_TIMESTAMP() * 1000, UNIX_TIMESTAMP() * 1000),
('ETHUSDT', 'USDT', 300000.00000000, 300000.00000000, 0.00000000,
 300000.00000000, 0.00000000, 0.00000000,
 0.00000000, 0.00000000, 0.00000000,
 0.00000000, 0.00000000, DATE_FORMAT(CURDATE(), '%Y%m%d'),
 300000.00000000, 300000.00000000,
 300000.00000000, 150000.00000000, 30000.00000000, 'SAFE',
 0, UNIX_TIMESTAMP() * 1000, UNIX_TIMESTAMP() * 1000)
