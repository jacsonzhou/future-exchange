...
# 做市商模块
echo ""
echo "[5/5] Creating Market Maker topics..."
...
$KAFKA_HOME/bin/kafka-topics.sh --list --bootstrap-server $BROKER_LIST | grep -E "funding|mark-price|tp-sl|margin|adl|insurance|mm-"
